...
{{-- <link href="{{ asset('gentelella-1.4.0/production/css/map/jquery-jvectormap-2.0.3.css') }}" rel="stylesheet"> --}}
{{-- <link href="{{ asset('gentelella-1.4.0/build/css/custom.css') }}" rel="stylesheet">
<link href="{{ asset('gentelella-1.4.0/build/css/custom.min.css') }}" rel="stylesheet"> --}}
{{-- <link href="{{ asset('gentelella-1.4.0/documentation/css/bootstrap.min.css') }}" rel="stylesheet"> --}}
<link href="{{ asset('gentelella-1.4.0/documentation/css/animate.min.css') }}" rel="stylesheet">
{{-- <link href="{{ asset('gentelella-1.4.0/documentation/css/docs.min.css') }}" rel="stylesheet">
<link href="{{ asset('gentelella-1.4.0/documentation/css/shCoreDefault.css') }}" rel="stylesheet">
